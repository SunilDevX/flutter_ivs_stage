...
class StageLayoutCalculator {
    ...
    func calculateFrames(participantCount: Int, width: CGFloat, height: CGFloat, padding: CGFloat) throws -> [CGRect] {
        if participantCount > 12 {
            throw NSError(domain: "StageLayoutCalculator", code: 1, userInfo: [
                NSLocalizedDescriptionKey: "Only 12 participants are supported at this time"
            ])
        }
